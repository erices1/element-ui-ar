<script>
  ...
  import ElRadio from 'element-ui-ar/packages/radio';
  import { isEqual, isRtl } from 'element-ui-ar/src/utils/util';
  ...
  export default {
    ...
    methods: {
      ...
      renderExpandIcon(h) {
        return (
          // TODO: rtl el-cascader 级联选择器 wenzc -- start
          <i class={{
            'el-icon-arrow-right': !isRtl(),
            'el-icon-arrow-left': isRtl(),
            'el-cascader-node__postfix': true
          }}></i>
          // TODO: rtl el-cascader 级联选择器 wenzc -- end
        );
      },
