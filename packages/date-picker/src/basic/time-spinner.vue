...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'element-ui-ar/src/utils/date-util';
  import ElScrollbar from 'element-ui-ar/packages/scrollbar';
  import RepeatClick from 'element-ui-ar/src/directives/repeat-click';
